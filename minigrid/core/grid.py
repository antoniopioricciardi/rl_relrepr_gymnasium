...
class Grid:
    ...
    def horz_wall(
        ...
        for i in range(0, length):
            self.set(x + i, y, obj_type(color=wall_color))
    ...
    def vert_wall(
        ...
        for j in range(0, length):
            self.set(x, y + j, obj_type(color=wall_color))

    def wall_rect(self, x: int, y: int, w: int, h: int, wall_color: str = "grey"):
        self.horz_wall(x, y, w, wall_color=wall_color)
        self.horz_wall(x, y + h - 1, w, wall_color=wall_color)
        self.vert_wall(x, y, h, wall_color=wall_color)
        self.vert_wall(x + w - 1, y, h, wall_color=wall_color)
