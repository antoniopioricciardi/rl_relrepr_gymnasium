...
env = EmptyDualEnv(size=args.grid_size, goal_shape=args.goal_shape, goal_pos=args.goal_pos, goal_color=args.goal_color, item_color=args.item_color, wall_color=args.wall_color, render_mode="human")
# env = EmptyEnv(size=8)
...
envs = gym.vector.SyncVectorEnv([ 
    make_env_atari(
        ...
        max_frames=False, episodic_life=False, clip_reward=False, check_fire=False, idx=i, capture_video=False, filter_dict=None, run_name='test'
        )
