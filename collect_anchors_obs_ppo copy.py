...
for i in range(len(actions_list)):
    ...
    if done:
        if env_id.startswith("CarRacing"):
            ...
            score = 0
            obs, _ = env.reset() # shouldn't call this. Vectorized env handles this. If I remove this, need to collect ALL data again
        # elif info["lives"] == 0:
        #     print('episode finished, score: ', score)
        #     scores.append(score)
        #     score = 0
...
with open(f"data/anchors/{env_id}/{env_info}_{encoder_algo}_transitions_{track_background}_obs.pkl", "wb") as f:
