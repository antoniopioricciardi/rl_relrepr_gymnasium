...
# python src/zeroshotrl/ppo_carracing_discrete_rgb_relrepr_end_to_end.py --track --wandb-project-name rlrepr_ppo_carracing_discrete --exp-name standard_green_rgb --env-id CarRacing-custom --seed 1 --num-envs 16 --background green --car-mode standard --stack-n 4 --total-timesteps 5000000
# python src/zeroshotrl/ppo_carracing_discrete_rgb_relrepr_end_to_end.py --track --wandb-project-name rlrepr_ppo_carracing_discrete --exp-name rel_standard_green_rgb --env-id CarRacing-custom --seed 1 --num-envs 16 --background green --car-mode standard --stack-n 4 --total-timesteps 5000000 --use-relative --anchors-path data/anchors/CarRacing-v2/rgb_ppo_transitions_green_obs.pkl --anchors-indices-path data/anchor_indices/CarRacing-v2_3136_anchor_indices_from_4000.txt --total-timesteps 5000000 --anchors-alpha 0.999

""" standard red: abs, rel """
# python src/zeroshotrl/ppo_carracing_discrete_rgb_relrepr_end_to_end.py --track --wandb-project-name rlrepr_ppo_carracing_discrete --exp-name standard_green_rgb --env-id CarRacing-custom --seed 1 --num-envs 16 --background multicolor --car-mode standard --stack-n 4 --total-timesteps 5000000
""" slow green: abs, rel """
# python src/zeroshotrl/ppo_carracing_discrete_rgb_relrepr_end_to_end.py --track --wandb-project-name rlrepr_ppo_carracing_discrete --exp-name slow_green_rgb --env-id CarRacing-custom --seed 1 --num-envs 16 --background green --car-mode slow --stack-n 4 --total-timesteps 5000000
# python src/zeroshotrl/ppo_carracing_discrete_rgb_relrepr_end_to_end.py --track --wandb-project-name rlrepr_ppo_carracing_discrete --exp-name rel_slow_green_rgb --env-id CarRacing-custom --seed 1 --num-envs 16 --background green --car-mode slow --stack-n 4 --use-relative --anchors-path data/anchors/Carracing-v2/rgb_ppo_transitions_green_obs.pkl --anchors-indices-path data/anchor_indices/CarRacing-v2_3136_anchor_indices_from_4000.txt --total-timesteps 5000000 --anchors-alpha 0.999
