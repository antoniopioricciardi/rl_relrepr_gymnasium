...
# python stitching_test_quantitative.py --stitching-mode absolute --encoder-env-id CarRacing-v2 --policy-env-id CarRacing-v2 --encoder-colors green --policy-colors multicolor --env-seeds 1 2 3 4 --encoder-seeds 1 2 3 4 --policy-seeds 1 2 3 4 --encoder-algo ppo --policy-algo ppo --encoder-activation-func relu --policy-activation-func relu --render-mode rgb_array
