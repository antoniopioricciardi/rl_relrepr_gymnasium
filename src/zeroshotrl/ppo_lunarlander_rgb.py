...
""" LUNAR LANDER """
""" white: abs, rel """
# python src/zeroshotrl/ppo_lunarlander_rgb.py --track --wandb-project-name rlrepr_ppo_lunarlander --exp-name white_rgb --env-id LunarLanderRGB --seed 1 --num-envs 16 --color white --gravity -10 --stack-n 4 --total-timesteps 5000000
