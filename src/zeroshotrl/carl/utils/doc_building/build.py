...
def build() -> Tuple[pd.DataFrame, Dict, Dict]:
    ...
    # Create snapshot
    local_vars = vars(zeroshotrl.carl.envs)
    ...
    from zeroshotrl.carl.envs.mario.carl_mario_definitions import CONTEXT_BOUNDS as mario_bounds
    from zeroshotrl.carl.envs.mario.carl_mario_definitions import DEFAULT_CONTEXT as mario_defaults
