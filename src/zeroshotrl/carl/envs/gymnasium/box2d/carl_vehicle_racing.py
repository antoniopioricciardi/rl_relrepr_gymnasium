...
from zeroshotrl.envs.carracing.car_racing import CarRacing, FrictionDetector
from gymnasium.envs.registration import register

from zeroshotrl.carl.context.context_space import ContextFeature, UniformIntegerContextFeature
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.bus import AWDBus  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.bus import AWDBusLargeTrailer  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.bus import AWDBusSmallTrailer  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.bus import Bus  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.bus import BusLargeTrailer  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.bus import BusSmallTrailer  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.bus import FWDBus  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.bus import FWDBusLargeTrailer  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.bus import FWDBusSmallTrailer  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.race_car import AWDRaceCar  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.race_car import FWDRaceCar  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.race_car import (  # as Car
...
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.street_car import AWDStreetCar  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.street_car import FWDStreetCar  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.street_car import StreetCar  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.street_car import (  # as Car
...
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.trike import TukTuk  # as Car
from zeroshotrl.carl.envs.gymnasium.box2d.parking_garage.trike import TukTukSmallTrailer  # as Car
from zeroshotrl.carl.envs.gymnasium.carl_gymnasium_env import CARLGymnasiumEnv
from zeroshotrl.carl.utils.types import ObsType
...
class CustomCarRacing(CarRacing):
    def __init__(
        ...
        super().__init__(verbose=verbose, render_mode=render_mode, background=background, 
                         continuous=continuous, zoom=zoom)
...
register(
    ...
    entry_point="zeroshotrl.carl.envs.gymnasium.box2d.carl_vehicle_racing:CustomCarRacing",
