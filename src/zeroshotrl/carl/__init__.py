...
#         register(
#             id=f"carl/{e}-v0",
#             entry_point=f"zeroshotrl.carl.envs.gymnasium.classic_control:{e}",
#         )
...
#             register(
#                 id=f"carl/{e}-v0",
#                 entry_point=f"zeroshotrl.carl.envs.gymnasium.box2d:{e}",
#             )
...
#             register(
#                 id=f"carl/{e}-v0",
#                 entry_point=f"zeroshotrl.carl.envs.dmc:{e}",
#             )
...
#             entry_point="zeroshotrl.carl.envs.mario:CARLMarioEnv",
#         )
# except:
#     print(
