...
""" LUNAR LANDER """
""" white: abs, rel """
# python src/zeroshotrl/ppo_lunarlander.py --track --wandb-project-name rlrepr_ppo_lunarlander --exp-name "states_standard" --env-id LunarLander --seed 1 --num-envs 16 --background white --gravity -10 --stack-n 4 --total-timesteps 1500000
""" rel augmented"""
...
if __name__ == "__main__":
    ...
    env = LunarLander(gravity=args.gravity)
    eval_env = LunarLander(gravity=args.gravity)
