...
""" MINIGRID """
"""  """
# python src/zeroshotrl/ppo_lunarlander_rgb.py --track --wandb-project-name rlrepr_ppo_minigrid --exp-name test --env-id Miniworld --seed 1 --num-envs 8 --num-eval-envs 1 --color white --gravity -10 --stack-n 4 --total-timesteps 25000000
