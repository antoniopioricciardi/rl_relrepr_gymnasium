...
""" MINIWORLD """
"""  """
# python src/zeroshotrl/ppo_miniworld.py --track --wandb-project-name rlrepr_ppo_miniworld --exp-name test --env-id Miniworld-SingleRoom-v0 --seed 1 --num-envs 8 --num-eval-envs 1 --background standard --stack-n 4 --total-timesteps 200000
