            ...
            for enc_seed in encoder_seeds:
                for pol_seed in policy_seeds:
                    ...
                    for i in env_seeds:
                        ...
                        print("----------------------------------")
                        print(
                            f"Testing on {enc_bg} background with {enc_bg} encoder (seed {enc_seed}) and {pol_bg} policy (seed {pol_seed}). Environment seed {cust_seed}"
                        )
                        ...
                        score, max_ep_score, ep_length = test_rel_repr_vec(
                            env_controller,
                            agent,
                            policy_algo,
                        ...
                        df = df.append(
                            {
                                ...
                                "score": score,
                                "max_score_reached": max_ep_score,
