...
from minigrid_original.core.constants import OBJECT_TO_IDX, TILE_PIXELS
from minigrid_original.core.world_object import Wall, WorldObj
from minigrid_original.utils.rendering import (
    downsample,
    fill_coords,
    highlight_img,
    point_in_rect,
