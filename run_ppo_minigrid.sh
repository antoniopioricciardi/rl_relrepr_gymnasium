...
if [ $run_mode == "ppo" ]
then
    python ppo_minigrid.py --track --wandb-project-name rlrepr_ppo_minigrid --exp-name "$car_mode"_"$background"_rgb --env-id minigrid-custom --seed 1 --num-envs 16 --grid-size $grid_size --goal-shape $goal_shape --goal-color $goal_color --item-color $item_color --wall-color $wall_color --stack-n 4 --total-timesteps 500000

    python ppo_minigrid.py --track --wandb-project-name rlrepr_ppo_minigrid --exp-name "$car_mode"_"$background"_rgb --env-id minigrid-custom --seed 2 --num-envs 16 --grid-size $grid_size --goal-shape $goal_shape --goal-color $goal_color --item-color $item_color --wall-color $wall_color --stack-n 4 --total-timesteps 500000

    python ppo_minigrid.py --track --wandb-project-name rlrepr_ppo_minigrid --exp-name "$car_mode"_"$background"_rgb --env-id minigrid-custom --seed 3 --num-envs 16 --grid-size $grid_size --goal-shape $goal_shape --goal-color $goal_color --item-color $item_color --wall-color $wall_color --stack-n 4 --total-timesteps 500000

    python ppo_minigrid.py --track --wandb-project-name rlrepr_ppo_minigrid --exp-name "$car_mode"_"$background"_rgb --env-id minigrid-custom --seed 4 --num-envs 16 --grid-size $grid_size --goal-shape $goal_shape --goal-color $goal_color --item-color $item_color --wall-color $wall_color --stack-n 4 --total-timesteps 500000
