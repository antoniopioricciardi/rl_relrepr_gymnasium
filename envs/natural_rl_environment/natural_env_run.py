...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", help="The gym environment to base on", default="BoxingNoFrameskip-v4")
    parser.add_argument("--imgsource", choices=["plain", "color", "noise", "images", "videos"])
    ...
    if not args.imgsource == "plain":
        env = NaturalEnvWrapper(args.env, args.imgsource, render_mode="human", color=args.color)
